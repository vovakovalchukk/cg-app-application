...
class PreviewProductDetail extends ProductDetail
{
    ...
    const HEIGHT = 74;
    const LENGTH = 120;
    const DESCRIPTION = 'This five-piece garden furniture set, including four chairs and a dining table, is the ideal furnishing for any garden or patio. Stylish, high-backed chairs and a generous, comfortable armrests make this a great place to serve dinner, enjoy a coffee or drinks, or simply relax in comfort and make the most of the summer with this fantastic set';
