                ...
                <svg viewBox="0 0 38 38" className="loading-indicator-element" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient x1="8.042%" y1="0%" x2="65.682%" y2="23.865%" id="indicator-gradient">
                            <stop stopColor={colorBlue} stopOpacity="0" offset="0%"></stop>
                            <stop stopColor={colorBlue} stopOpacity=".631" offset="63.146%"></stop>
                            <stop stopColor={colorBlue} offset="100%"></stop>
                        </linearGradient>
                    </defs>
                    <g fill="none" fillRule="evenodd">
                        <g transform="translate(1 1)">
                            <path d="M36 18c0-9.94-8.06-18-18-18" id="Oval-2" strokeWidth="2" stroke="url(#indicator-gradient)" transform="rotate(198.457 18 18)">
