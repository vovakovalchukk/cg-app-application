define([
    ...
    Service.prototype.fetchCollectionByFilter = function(filter, page, sortDescending, callback)
    {
        this.getStorage().fetchCollectionByFilter(filter, page, sortDescending, function(threads) {
