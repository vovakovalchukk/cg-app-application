define(['react', 'Common/IdGenerator', 'EmailDesigner/Components/Elements/Text'], function (React, IdGenerator, Text) {
    "use strict";

    var ElementList = function () {
        this.elements = {
            'Text': function (elementData) {
                return React.createElement(Text, { id: elementData.id,
