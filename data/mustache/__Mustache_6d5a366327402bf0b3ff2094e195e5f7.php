...
class __Mustache_6d5a366327402bf0b3ff2094e195e5f7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section14d192b5784f4527c3e1a7a377336101($context, $indent, $value);
...
';
    ...
    private function section14d192b5784f4527c3e1a7a377336101(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <li><a href="#" class="custom-select-item" title="{{column}}"><input type="checkbox"  />{{column}}</a></li>
                ';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('column'), $context, $indent);
