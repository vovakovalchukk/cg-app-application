...
class __Mustache_7bb2109e26ea0190b05c88a2d2ed74fd extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section20d7b81910e2e334081bdcf8242be4fc($context, $indent, $value);
...
';
    ...
    private function section20d7b81910e2e334081bdcf8242be4fc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <li><a href="#" class="custom-select-item" title="{{title}}"><input type="checkbox"  />{{title}}</a></li>
                    ';
